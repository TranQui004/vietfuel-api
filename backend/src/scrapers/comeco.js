...
const COMECO_URL = 'https://comeco.vn' || 'https://comeco.vn';
...
async function scrapeComeco() {
  ...
  console.log(`[Scraper:Comeco] Xong. ${stdPrices.length} items. priceDate=${priceDate || 'null'} (${((Date.now() - start) / 1000).toFixed(2)}s)`);
